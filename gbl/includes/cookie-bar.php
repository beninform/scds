...
<div id="cookieOverlay"> <!-- overlay div 100% -->
    ...
    <div id="cookieOverlayText"> <!-- text 50% -->
        ...
        <p>For more detailed information, see our <a class="scdslink" href="/gbl/data-protection-scds.php" target="_blank">website data protection statement</a> (opens in new tab).</p>
